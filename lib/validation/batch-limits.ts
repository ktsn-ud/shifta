...
// 一括登録と同じ上限だが、API/UIの用途を明確にするため編集用に分ける。
export const MAX_BULK_SHIFT_EDIT_COUNT = 31;
...
export const BULK_SHIFT_EDIT_LIMIT_MESSAGE = `一括編集は${MAX_BULK_SHIFT_EDIT_COUNT}件までです。`;
