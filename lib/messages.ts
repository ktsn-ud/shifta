...
export const messages = {
  ...
  error: {
    ...
    shiftConfirmFailed: "シフトの確定に失敗しました。",
    shiftDeleteFailed: "シフトの削除に失敗しました。",
    ...
    actualPayrollSaveFailed: "実給与の保存に失敗しました。",
